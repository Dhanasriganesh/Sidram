            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-slate-50/80 py-2 pl-3 pr-10 text-sm text-slate-900 outline-none ring-teal-600/30 transition focus:border-teal-500 focus:bg-white focus:ring-2"
                  placeholder="••••••••"
                />
                <button
                  type="button"
